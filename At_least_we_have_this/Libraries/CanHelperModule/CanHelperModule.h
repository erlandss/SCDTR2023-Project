...
enum can_cmds {
  ...
  CAN_REPLY_ENERGY_CONSUMTION,
  CAN_GET_VISIBILITY_ERROR,
  CAN_REPLY_VISIBILITY_ERROR,
  CAN_GET_FLICKER_ERROR,
  CAN_REPLY_FLICKER_ERROR,
